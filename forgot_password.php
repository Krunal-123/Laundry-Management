...
try {
    ...
    $mail->Body    = '<h2>Someone Is Change Your Loundry Account Password</h2>
...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
  ...
  <body>
  <form method="post">
    <img src="https://th.bing.com/th/id/OIP.EoA14oU2D9y6MJr1iv-W8QHaHa?rs=1&pid=ImgDetMain" alt="">
    <h1>Reset User Password</h1>
      <label for="email">Email Id:</label><br>
      <input type="email" name="email" required value="<?php echo $row['email']?>" readonly><br>
      <br>
      ...
      <br>
      <a href="dashboard.php" class="my-3">Go Back</a>
    </form>
  </body>
