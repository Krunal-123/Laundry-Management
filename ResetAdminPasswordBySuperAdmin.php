...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
  ...
  <form method="post">
    ...
    <h1>Reset Admin Password</h1>
      ...
      <input type="email" name="email" value="<?php echo $_POST["email"];?>" readonly required><br>
      <br>
      ...
      <a href="view_admins.php" class="my-3">Other Admins</a>
    </form>
                 ...
                 <div class="modal-content">
                   <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <!-- form -->
                      <form class="for" action="ResetAdminPasswordBySuperAdmin.php" method="post" autocomplete="off">
                      <img src="https://th.bing.com/th/id/OIP.9bLa6OsvYEWKly7Zu9bUowHaHa?rs=1&pid=ImgDetMain" alt="">
                      <h2>SUPER ADMIN</h2>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" name="p" class="btn btn-primary">SUBMIT</button>
                      </div>
                    </form>
                  </div>
                </div>
