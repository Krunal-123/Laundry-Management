...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    <title>Loundry users-view-ByAdmin</title>
  ...
  <body>
        ...
        <?php while($row = mysqli_fetch_assoc($result)): ?>
          ...
          <?php  $id=$row['user_id'];?>
            ...
            <?php if ($row['status']!='Delivered'):?>
              ...
              <!-- Delete btn -->
              <a href="delete2.php?id=<?php echo$id?>">
                 ...
                 <div class="modal-content">
                   <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <!-- form -->
                      <form class="for" action="update2.php" method="post" autocomplete="off">
    ...
    <div class="d-flex justify-content-around m-0">
      ...
      <button class="btn-sm btn-primary m-1">
        <a class="text-light" style="text-decoration:none;" href="feedback2.php">User feedback</a>
      </button>
    </div>
    </footer>
  </body>
